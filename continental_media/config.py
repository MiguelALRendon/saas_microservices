...
class Config:
    ...
    PORT = int(os.environ.get('PORT') or 8102)
    DEBUG = os.environ.get('DEBUG', 'False').lower() in ('true', '1', 't')
    BASE_URL = os.environ.get('BASE_URL') or 'http://localhost:8102'
    ...
    # Upload folder — apuntar al mismo directorio de ContinentalApi en producción
